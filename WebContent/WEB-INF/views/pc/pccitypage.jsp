...
<div class="weui_cells" style="margin-top: 0px;border-top: 0px;">
	        <div class="weui_cell"  style="padding:5px 15px;">
	            <div class="weui_cell_bd weui_cell_primary">
	                 <a href="${ctx}/data/pcchartindex"   class="weui_btn weui_btn_mini weui_btn_default left_side">&lt;返回</a> 
	            </div>
...
function binddata(stime,etime){
	...
	$.ajax({
		...
		for(var k=0;k<len;k++){
			...
			citylist+="</div>";
			citylist+="</div>";
			citylist+="<div id=\""+k+"\" class=\"showdata approval-tline\" style=\"margin-bottom: 0px;overflow-x: hidden;\" ></div>";
		}
